...
export const riskRules: RiskFactor[] = [
  ...
  { id: "symptom.drowning", version: "1.2.0", keyword: "drowning", keywords: ["drowning", "near drowning", "submersion", "ertrinken", "beinahe ertrunken", "untergegangen"], weight: 10, level: "emergency", emergency: true },
  { id: "symptom.electric-shock", version: "1.2.0", keyword: "electric shock", keywords: ["electric shock", "electrical shock", "electrocution", "stromschlag", "elektrischer schlag", "elektrotrauma"], weight: 10, level: "emergency", emergency: true },
  { id: "symptom.major-trauma", version: "1.2.0", keyword: "major trauma", keywords: ["major trauma", "major injury", "serious injury", "schweres trauma", "schwere verletzung", "schwer verletzt"], weight: 10, level: "emergency", emergency: true },
  { id: "symptom.sudden-vision-loss", version: "1.2.0", keyword: "sudden vision loss", keywords: ["sudden vision loss", "sudden loss of vision", "blindness", "plötzlicher sehverlust", "plötzlicher verlust des sehvermögens", "blindheit"], weight: 10, level: "emergency", emergency: true },
  { id: "symptom.severe-eye-injury", version: "1.2.0", keyword: "severe eye injury", keywords: ["severe eye injury", "serious eye injury", "penetrating eye injury", "schwere augenverletzung", "ernste augenverletzung", "durchdringende augenverletzung"], weight: 10, level: "emergency", emergency: true },
  { id: "symptom.severe-facial-swelling", version: "1.2.0", keyword: "severe facial swelling", keywords: ["severe facial swelling", "swelling of face", "swollen face", "starke gesichtsschwellung", "gesicht stark angeschwollen", "geschwollenes gesicht"], weight: 10, level: "emergency", emergency: true },
