import {
  createCryptoPipeline,
} from "../storage/repository/storageServiceFactory";
import {
  EncryptedRepository,
} from "../security/storage/encryptedRepository";
import {
  MemorySecureStorage,
} from "../security/storage/secureStorage";
import {
  HealthRecordRepository,
} from "./healthRecordRepository";
